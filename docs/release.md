...
3. A PAL C64/VICE smoke test runs the visualizer without a CPU jam and keeps the border, background, and sealed right edge black. Capture at least one quiet and one peak-energy frame when presentation assets change.
